...
const address = "North Matrixville Subdivision, Camarin, Caloocan, Philippines";
    ...
    <PublicPage eyebrow="Contact" title="We'd love to hear from you" description="Planning your first visit or looking for church information? Here are the best ways to reach us.">
      <section className="public-section contact-layout" aria-label="Church contact and location">
        <article className="public-card contact-card">
          <div className="contact-method"><span className="contact-method-icon"><MapPin size={21} aria-hidden="true" /></span><div><h2>Visit Us</h2><p>{address}</p></div></div>
        ...
        <article className="public-card map-card">
          <iframe title="Map showing God's Grace Community Covenant Church in Camarin, Caloocan" src="https://www.google.com/maps?q=God's+Grace+Community+Covenant+Church&output=embed" loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
