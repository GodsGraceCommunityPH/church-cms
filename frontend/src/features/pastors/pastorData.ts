...
export type PastorProfile = { slug: string; name: string; photo: string; additionalPhotos: string[] };

export const pastors: PastorProfile[] = [
  { slug: "edward-morales", name: "Pastor Edward Morales", photo: edwardMain, additionalPhotos: [edwardTwo, edwardThree, edwardFour] },
