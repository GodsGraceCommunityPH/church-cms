...
export interface Resource{id:string;title:string;description:string;category:ResourceCategory;originalFileName:string;fileType:string;mimeType:string;fileSize:number;storagePath:string;previewStoragePath:string;previewFileName:string;previewMimeType:string;previewFileSize:number;createdAt:string;updatedAt:string}
...
export function isPowerPoint(r:Pick<Resource,'fileType'>){return r.fileType==='ppt'||r.fileType==='pptx'}
